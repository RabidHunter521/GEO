...
_QUERY_TEMPLATES = (
    ...
    # A café and a caterer are not asked the same things. Each anchor is chosen
    # to match what the question can pay for: {brand}-anchored yes/no questions
    # land in `brand`, which is NOT ranked — correct, there is nothing to rank.
    ...
    # position-extraction call (bar_open_late below). What to avoid is an
